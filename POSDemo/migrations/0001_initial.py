# Generated by Django 4.1.7 on 2023-08-14 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='POSDemo.business')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='POSDemo.categories')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('Transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='POSDemo.transactiondetailsmaster')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='POSDemo.business')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='POSDemo.customer')),
                ('item_master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='POSDemo.itemmaster')),
                ('item_variation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='POSDemo.itemvariation')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='POSDemo.storemaster')),
                ('store_stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='POSDemo.storestock')),
            ],
        ),
        migrations.CreateModel(
            name='Roles',
        ...
        migrations.AddField(
            model_name='itemattributesoptions',
            name='item_master_id',
